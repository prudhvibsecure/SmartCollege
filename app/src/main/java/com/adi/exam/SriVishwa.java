            ...
            switch (v.getId()) {
                ...
                case R.id.tv_updateok:
                    if (checkPermission("android.permission.READ_EXTERNAL_STORAGE", 400) == 1) {
                        ...
                        Utils.downloadDilog(this);
                        startService(ApkFileDownloader.getDownloadService(this, "https://bsecuresoftechsolutions.com/smc_api/assets/upload/version/", String.valueOf(mediaStorage), "viswa.apk"));
                    }
